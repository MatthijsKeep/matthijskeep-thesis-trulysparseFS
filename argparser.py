...
def get_parser():
    ...
    parser.add_argument('--running_remote', type=bool, default=False, help='If the code is running on a remote server, set this to True. This will run the testing multiple times instead of once.')
