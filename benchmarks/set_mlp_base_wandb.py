...
class SET_MLP:
    def __init__(
        self, dimensions, activations, epsilon=20, weight_init="he_uniform", config=None
    ):
        """
...
if __name__ == "__main__":
    ...
    for i in range(runs):
        ...
        set_mlp.fit(
            ...
            testing=True,
            save_filename="results/set_mlp_sequential_"
    ...
    np.savetxt(
        f"benchmarks/results/truly_sparse_base/{data}_{runs}.csv",
        svm_accs,
        delimiter=",",
    )
